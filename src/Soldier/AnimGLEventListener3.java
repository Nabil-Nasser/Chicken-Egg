...
public class AnimGLEventListener3 extends AnimListener {
    ...
    int maxWidth = 100;
    int maxHeight = 100;
    float x = maxWidth/2, y = maxHeight/30;
    
    ArrayList<Bullet> bullets = new ArrayList<>();
    
    String textureNames[] = {"basket.png","basket.png","basket.png","basket.png","egg.png","Back1.png"};
...
//        DrawGraph(gl);
        ...
        for (Bullet bullet : bullets) {
            ...
            bullet.bounce(maxWidth,maxHeight);
               DrawSprite(gl, bullet.x, bullet.y+yy, 4, 0.3f, Directions.down);
               yy--;
        }
